...
$sql = "select CompanyName, ContactName, ContactTitle, Country from customers where ContactTitle like '%marketing%' and Country = 'USA'";
$sql_type = 0; /* SQL type */
if(isset($_GET["t"])) {
$sql_type = $_GET["t"];
switch ($_GET["t"]) {
...
/* Section 5 : Display data Tabla 1 */
